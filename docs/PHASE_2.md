...
| Shape-preserving LOD | **Pending** (method comparison recorded, [#126](https://github.com/1n01raymond/naru/issues/126)) | Define geometric/screen error, identity and edge behavior, compiler representation, and reference-image gates |
